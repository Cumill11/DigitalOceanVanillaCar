...
import {AddCarFromAllCars} from "./AddCarFromAllCars";
...
export default class AllCars extends Component {
    ...
    componentDidMount() {
        ...
        if (currentUser === null) {
            ...
            if (currentUser.roleid === 1 || currentUser.roleid === 3) this.setState({redirect: "/car"});
            ...
            (response) => {
                ...
                this.setState({
                    car: this.state.car.sort(function (a, b) {
                        return a.user.userEmail - b.user.userEmail ? 1 : -1
                    })
                })
            },
            (error) => {
                    ...
                    <div>
                        ...
                        <Table responsive className="mt-4" striped bordered hover size="sm">
                            ...
                            <tr>
                                ...
                                <th class="text-center">Adres Email klienta</th>
                            ...
                            {car.map((car) => (
                                <tr key={car.carId}>
                                    ...
                                    <td class="text-center">{car.user.userEmail}</td>
                                    <td align="center">
                                        <Button
                                            className="mr-2"
                                            variant="secondary"
