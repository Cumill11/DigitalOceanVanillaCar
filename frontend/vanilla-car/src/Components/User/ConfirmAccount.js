...
export class ConfirmAccount extends Component {
    ...
    handleLogin(e) {
        ...
        if (this.checkBtn.context._errors.length === 0) {
            AuthenticateService.confirmaccount(
                this.state.UserCode,
                ...
                (error) => {
                    ...
                    if (error.response.status === 404) {
                        this.setState({
                            loading: false,
                            message:
                                "Podany email lub kod jest nieprawidłowe",
                        });
                    } else if (error.response.status === 400) {
                        this.setState({
                            loading: false,
                            message:
                                "Konto już potwierdzone, zaloguj się",
                        });
                    } else
                        this.setState({
                            loading: false,
                        ...
                        <Row>
                            ...
                            >
                                <div className="mb-4">
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="email">Kod z e-maila</label>
                                        <Input
                                            type="text"
                                            className="form-control"
                                            name="Email"
