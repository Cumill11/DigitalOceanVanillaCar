...
namespace backend.Services
{
    public class UserService : IUserService
    {
        ...
        public void RegisterUser(RegisterUser register)
        {
            ...
            template.AppendLine(
                "Kliknij <html><a href='http://vanillacar.me/emailconfirm?email=@Model.Email&code=@Model.RandomString'>tutaj</a></html> aby potwierdzić konto");
            template.AppendLine("<br>");
        ...
        public void SendResetMail(ResetPassword resetPassword)
        {
            ...
            template.AppendLine(
                "Aby zresetować hasło, kliknij <html><a href='http://vanillacar.me/recoverconfirm'>tutaj</a></html> i wpisz podany kod z maila");
            template.AppendLine("<br>");
